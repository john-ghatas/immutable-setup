...
BIN_DEVELOPMENT=(/usr/bin/jq /usr/bin/nmap /usr/bin/nc /usr/bin/tig /usr/bin/ansible /usr/bin/ansible-playbook /usr/bin/ansible-galaxy /usr/bin/terraform /usr/bin/packer /usr/bin/iperf3)
