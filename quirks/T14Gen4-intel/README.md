...
```
rpm-ostree kargs --append='i915.enable_psr=1 thinkpad_acpi.fan_control=1 pcie_aspm=force pcie_aspm.policy=powersave pcie_port_pm=force i915.enable_fbc=1 nvme_core.default_ps_max_latency=0'
```
