...
rpm-ostree rebase fedora:fedora/$NEXT_VERSION/x86_64/$VARIANT_ID \
  ...
  --install=http://mirror.dst.ca/rpmfusion/free/fedora/rpmfusion-free-release-$NEXT_VERSION.noarch.rpm
